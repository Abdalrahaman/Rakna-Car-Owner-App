...
//  private int milesAbbreviationColor = 0;
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    int singleRvCardToUse = R.layout.card_garage_info_list_item;
  ...
  public interface ClickListener {
    ...
    void expandedBottomSheetBehavior();
  }
...
//      phoneHeaderTextView = itemView.findViewById(R.id.phone_header_tv);
      ...
      reserveButtonView = itemView.findViewById(R.id.btn_reserve);
...
//      milesAbbreviationTextView = itemView.findViewById(R.id.miles_mi_tv);
      ...
      cardView.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            clickListener.expandedBottomSheetBehavior();
          }
      });
